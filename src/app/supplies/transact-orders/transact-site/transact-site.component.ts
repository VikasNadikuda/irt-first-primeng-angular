...
@Component({
  selector: 'app-transact-site',
  templateUrl: './transact-site.component.html',
  styleUrls: ['./transact-site.component.css']
})
export class TransactSiteComponent implements OnInit {
  @BlockUI('transactSites') loader: NgBlockUI;
  title="Depot Orders"
  items: MenuItem[];
