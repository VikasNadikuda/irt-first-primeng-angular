...
@Component({
  selector: 'app-add-edit-depots',
  templateUrl: './add-edit-depots.component.html',
  styleUrls: ['./add-edit-depots.component.css']
})
export class AddEditDepotsComponent implements OnInit {
  @BlockUI('addDepots') loader: NgBlockUI;
